...
* ビブラートの周期 = 速さ / 60(or 50)[s]
* 2^n-1が安定しやすい周期(15,31,63,...)
* 深さが255のとき、半音2つ分(長２度)ピッチする  
...
```
<チャンネルシンボル><"."><名前> <MMLステートメント>

* スペースには<" ">* が入る
* チャンネルシンボルは A,B,C,D,Eまたはこれらの組み合わせ
```
