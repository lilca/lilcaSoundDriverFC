...
|アルペジオ(*3)|@EN[n]|EN[n]|あり(*2)|ENOF|12TN (*1)|フレーム単位で<br>音階を変化させる|
|ピッチ(*3)|@EP[n]|EP0|あり(*2)|EPOF|12TN (*1)|フレーム単位で<br>指定方向と量で<br>音階を変化させる|
|ビブラート(*3)|@MP[n]|MP[n]|-|MPOF|12TN (*1)|指定された<br>周期と振幅のSin波で<br>音階を変化させる|
|DPCM割り当て(*3)|@DPCM[n]|音階|-|-|D (*1)|n=0,1,2,3,4...<br>-> c,c+,d,d+,e...<br>に割り当て|
