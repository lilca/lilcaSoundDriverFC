...
|ビット|範囲|説明|
|:-:|:-:|:-|
|1000-0000<br>0000-0000<br>0111-1111|-128 ~ 0 ~ 127|数値|

* ループバックシンボル '|' は内部的に256(2バイトデータなので重複はしない)で処理する
...
|相対音階|-128~127|cに対して<br>1 は c+<br>-1 は b|
|増減値|-128~127|矩形波と三角波 -> 11bitタイマー<br>ノイズ波 -> 4bitピリオド|
